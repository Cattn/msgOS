...
async function GetAllApps() {
  ...
  function createWindow(app) {
    ...
    appWindow.setAttribute('id', app.name);
    ...
    appFrame.setAttribute('id', app.name + '-frame');

    let topBar = document.createElement('div');
    topBar.classList.add('top-bar');
    topBar.setAttribute('id', app.name + '-bar');
    topBar.style.width = app.width;
    topBar.style.height = "40px";

    topBar.innerHTML += `
    <svg class="top-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M24 432c-13.3 0-24 10.7-24 24s10.7 24 24 24H488c13.3 0 24-10.7 24-24s-10.7-24-24-24H24z"/></svg>
          <svg class="top-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          ...
          <svg class="top-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M376.6 84.5c11.3-13.6 9.5-33.8-4.1-45.1s-33.8-9.5-45.1 4.1L192 206 56.6 43.5C45.3 29.9 25.1 28.1 11.5 39.4S-3.9 70.9 7.4 84.5L150.3 256 7.4 427.5c-11.3 13.6-9.5 33.8 4.1 45.1s33.8 9.5 45.1-4.1L192 306 327.4 468.5c11.3 13.6 31.5 15.4 45.1 4.1s15.4-31.5 4.1-45.1L233.7 256 376.6 84.5z"/></svg>
          `    
